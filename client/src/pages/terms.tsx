      ...
      <main className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-xl text-muted mb-8">Last updated: 7 September 2025</h2>
            ...
            <p className="text-muted leading-relaxed mb-4">
              <strong>Cancellation.</strong> You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please contact us at{' '}
            ...
            <p className="text-muted leading-relaxed mb-4">
              If you have any questions or concerns about these Terms, please contact us at <a href="mailto:support@emdrise.com" className="text-primary hover:opacity-80">support@emdrise.com</a>.
            </p>
          </div>
        </div>
      </main>
