        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#features" className="text-white/80 hover:text-white transition-colors focus-visible" data-testid="link-footer-features">Features</a></li>
              <li><a href="#" className="text-white/80 hover:text-white transition-colors focus-visible" data-testid="link-footer-pricing">Pricing</a></li>
              <li><a href="#" className="text-white/80 hover:text-white transition-colors focus-visible" data-testid="link-footer-download">Download</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/80 hover:text-white transition-colors focus-visible" data-testid="link-footer-contact">Contact</a></li>
